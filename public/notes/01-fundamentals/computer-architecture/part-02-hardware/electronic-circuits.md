...
Computers ultimately store and move **[[Bit|bits]]**. In many memories, a cell’s **charged vs empty** state (simplified) represents **1 vs 0**. [[CPU|Processors]] interpret patterns of bits as **data** and **instructions**.
...
More on filesystems and deletion semantics: [[Memory_Storage_Filesystems_and_Paths]].

## Related notes

- [[CPU]]
- [[Bit]]
- [[SoC_and_GPU]] — massive parallelism packs **many transistors** into GPUs and SoCs
